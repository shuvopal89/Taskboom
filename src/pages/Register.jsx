...
import { useUserRegisterMutation } from "../services/authApis";
...
function Register() {
  ...
  return (
    <div className="h-screen w-full bg-gray-900 bg-[url('../background.png')] bg-no-repeat bg-cover">
      <Title title={"Join on Taskboom"} />
        ...
        <div className="w-full h-screen bg-gray-900 relative border-r-[1px] border-gray-800">
          <div className="max-w-[400px] max-[900px]:px-3 text-gray-200 h-max absolute top-0 left-0 right-0 bottom-0 m-auto">
            <RegisterLoginCommonLeft
              ...
              desc={"Manage your daily personal and professional task easily."}
              googleAuthText={"Signup with google"}
            />
