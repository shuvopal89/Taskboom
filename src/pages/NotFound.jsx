  ...
  return (
    <div className='w-full h-screen bg-gray-900'>
      <div className='max-w-[500px] absolute -top-0 -bottom-0 -left-0 -right-0 m-auto flex flex-col items-center justify-center'>
        ...
        <button onClick={() => navigate(-1)} className='text-sm text-gray-900 bg-red-500 font-bold py-[10px] px-6 rounded-full mt-6 hover:bg-red-400 transition-all'>Go to dashboard</button>
      </div>
    </div>
  )
}
